...
if uploaded_file is not None:
    ...
    story_pipe = pipeline("text-generation", model="roneneldan/TinyStories-33M", max_new_tokens=150, do_sample=True, temperature=0.7)
     # Control the length and Make the story more coherent
